...
import UniversityCarousel from '../ui/modified-3d-carousel';
...
const InteractiveHero: React.FC = () => {
   ...
   const handleContactSubmit = useCallback(async (e: FormEvent<HTMLFormElement>) => {
       ...
       try {
           ...
           // In production, you'd want to use a backend service like EmailJS or your own API
           const subject = encodeURIComponent('Contact Form Submission');
           const body = encodeURIComponent(`From: ${contactForm.email}\n\nMessage:\n${contactForm.message}`);
           const mailtoLink = `mailto:mighytmonarch07@gmail.com?subject=${subject}&body=${body}`;
           
           // Use a more reliable method to open mailto links
   ...
   const handleContactFormChange = useCallback((field: keyof ContactFormData, value: string) => {
            ...
            {isContactModalOpen && (
                ...
                >
                    <motion.div
                        ...
                        className="bg-[#1a1a1a] border border-gray-700 rounded-lg p-6 w-full max-w-md mx-auto"
                        ...
                        <form onSubmit={handleContactSubmit} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 rounded-md bg-[#2a2a2a] border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0CF2A0] focus:border-transparent transition-all"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-3 py-2 rounded-md bg-[#2a2a2a] border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0CF2A0] focus:border-transparent transition-all resize-none"
                                    placeholder="Your message here..."
                                />
                            </div>

                            {submitStatus && (
                                <div className={`text-sm p-2 rounded ${submitStatus.includes('Error') ? 'text-red-400 bg-red-900/20' : 'text-green-400 bg-green-900/20'}`}>
                                    {submitStatus}
                                </div>
                            )}
                            ...
                            <div className="flex gap-3 pt-2">
                                <button
                                    type="button"
                                    onClick={() => setIsContactModalOpen(false)}
                                    className="flex-1 px-4 py-2 rounded-md border border-gray-600 text-gray-300 hover:bg-gray-700/50 transition-colors"
                                >
                                    Cancel
                                </button>
                                <button
                                    ...
                                    className="flex-1 bg-[#0CF2A0] text-[#111111] px-4 py-2 rounded-md font-semibold hover:bg-opacity-90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                >
